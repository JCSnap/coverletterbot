...
(NAME1, COURSE1, YEAR1, UNIVERSITY1, COMMENTS1, ADDCOMMENTS1, MODEL1, REPORT1, LIST1,
 COMPANY1, COMPANY2, FINAL1, SETTINGSOPT1, FINETUNE1, LENGTH1, CREATIVITY1) = range(16)
...
async def info(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
  ...
  "/list to generate a list of 10 companies of your chosen type. \n"
  "/more to generate another list of 10 companies of your most recent type. "
  )
...
async def more(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
  global company_type_previous
  prediction_table = wandb.Table(columns=["prompt", "completion"])
  prompt = f"This is a list of Singapore companies of type: {company_type_recent}, continue the list with another 10. {company_type_previous}"
  print(prompt)
  ...
  company_type_list = completions.choices[0].text  
  company_type_previous = company_type_previous + company_type_list
  await update.message.reply_text("If more than 8 seconds have passed and the list has not been generated, consider altering your prompt in /list ")
  await update.message.reply_text(company_type_list)
  return ConversationHandler.END
...
async def list1(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
  company_type = update.message.text
  global company_type_recent
  global company_type_previous
  company_type_recent = company_type
  company_type_previous = ""
  prediction_table = wandb.Table(columns=["prompt", "completion"])
  prompt = f"Generate a random list of 10 Singapore companies of type: {company_type_recent}, with a short (around 10 words) description of each"
  ...
  company_type_previous = company_type_previous + company_type_list
  await update.message.reply_text(company_type_list)
  await update.message.reply_text("Type /more to generate more.")
  return ConversationHandler.END
...
def main() -> None:
  ...
  conv_handler = ConversationHandler(
        ...
        states={
            ...
            LIST1: [MessageHandler(filters.TEXT, list1)],
        },
